...
switch(_type) do
{
    case "CUP_USSpecialWeapons_EP1":{["AmmoboxInit",[_crate, true]] spawn BIS_fnc_arsenal; [_crate, ["<t color='#B570E8C9'>Loadout</t>", { createDialog "dialog_LoadoutRequest" },"",6,true,false,"","(side player == civilian)"]] remoteExec ["addAction"];};
