...
[_display] spawn
{
    ...
    {
        if (missionNamespace getVariable["server_insurgent1", 0] != 0) then
        {
            _insurgentSelected1 = _display displayCtrl 7004;
            _insurgentSelected1 ctrlSetBackgroundColor [0.302,0.302,0.302,0.75];
            ctrlEnable [7001, false];
        };
        if (missionNamespace getVariable["server_insurgent2", 0] != 0) then
        {
            _insurgentSelected2 = _display displayCtrl 7005;
            _insurgentSelected2 ctrlSetBackgroundColor [0.302,0.302,0.302,0.75];
            ctrlEnable [7002, false];
        };
        if (missionNamespace getVariable["server_insurgent3", 0] != 0) then
        {
            _insurgentSelected3 = _display displayCtrl 7006;
